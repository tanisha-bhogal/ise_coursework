...
project = 'caffe'  # Change this to the desired project
...
for repeated_time in range(REPEAT):
    ...
    X_train = tfidf.fit_transform(train_text).toarray() # Convert sparse matrix to dense for GaussianNB
    X_test = tfidf.transform(test_text).toarray() # Use the same vectorizer for test data
